<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Fancybox.aspx.cs" Inherits="img_Fancybox" %>
	...
	<div class="section-gallery p-t-118 p-b-100">
		<div class="wrap-label-gallery filter-tope-group size32 flex-w flex-sb-m m-l-r-auto flex-col-c-sm p-l-15 p-r-15 m-b-60">
            ...
            <div class="size32 m-l-r-auto">
                ...
                <button class="label-gallery txt26 trans-0-4" data-filter=".jidlo">
                    Jídlo
                </button>

                <button class="label-gallery txt26 trans-0-4" data-filter=".portrety">
                    Portréty
                </button>

                <button class="label-gallery txt26 trans-0-4" data-filter=".priroda">
                    Příroda
                </button>

                <button class="label-gallery txt26 trans-0-4" data-filter=".veci">
                    Věci
                </button>

                <button class="label-gallery txt26 trans-0-4" data-filter=".zvirata">
                    Zvířata
                </button>

                <button class="label-gallery txt26 trans-0-4" data-filter=".ostatni">
                    Ostatní
                </button>
            </div>
		</div>
